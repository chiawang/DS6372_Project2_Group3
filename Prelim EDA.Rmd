...
### HeatMap
```{r}
ggplot(data = data,aes(x = race, y = ageGrp)) +labs(title="(Race & Age) Vs Readmission", y="Age Group", x="Race")+geom_tile(aes(fill = outcome))

ggplot(data = data, aes(x = time_in_hospital, y = ageGrp)) + labs(title="(Time in hospital & Age) Vs Readmission", y="Patient Age Group", x="Time in hospital") + geom_tile(aes(fill = outcome))

ggplot(data = data, aes(x = ageGrp, y = diag_1)) + labs(title="(Age & Diag_1) Vs Readmission", y="Patient Age Group", x="Daig_1") + geom_tile(aes(fill = outcome))

ggplot(data = data, aes(x = ageGrp, y = diag_2)) + labs(title="(Age & Diag_2) Vs Readmission", y="Patient Age Group", x="Daig_2") + geom_tile(aes(fill = outcome))

ggplot(data = data, aes(x = data$ageGrp, y = data$diag_3)) + labs(title="(Age & Diag_3) Vs Readmission", y="Patient Age Group", x="Daig_3") + geom_tile(aes(fill = outcome))
