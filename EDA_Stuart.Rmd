...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = race, fill = readmitted)) +
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = gender, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = admission_type_id, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = discharge_disposition_id, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = admission_source_id, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = payer_code, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
grid.arrange(p1, p2, ncol = 2)
data %>%
  ggplot(aes(x = number_diagnoses, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = max_glu_serum, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = A1Cresult, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = change, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = diabetesMed, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = metformin, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = repaglinide, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = nateglinide, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = chlorpropamide, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = glimepiride, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = acetohexamide, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = glipizide, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = glyburide, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = tolbutamide, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = pioglitazone, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = rosiglitazone, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = acarbose, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = miglitol, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = troglitazone, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = tolazamide, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = examide, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = citoglipton, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = `glyburide-metformin`, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = `glipizide-metformin`, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = `glimepiride-pioglitazone`, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = `metformin-rosiglitazone`, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
...
p1 <- data %>%
  ...
  geom_bar()
p2 <- data %>%
  ggplot(aes(x = `metformin-pioglitazone`, fill = readmitted)) +
  geom_bar(position = 'fill') +
  coord_flip()
grid.arrange(p1, p2, ncol = 2)
```
